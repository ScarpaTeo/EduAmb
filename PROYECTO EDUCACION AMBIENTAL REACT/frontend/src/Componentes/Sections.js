    ...
    if(this.state.master===true){
      Masopciones=<React.Fragment>
        <div className="row justify-content-center  pepito pt-3  fixed-bottom"></div>
            ...
            <div className="col-5 col-md-2 my-2 mx-2 mx-md-3 cajitas px-0 py-3 animated bounceInRight slower" style={{"background-color": "rgb(60, 228, 116)"}}>
         ...
         <div className="col-12 fixed-top mt-4 ">
            ...
            <div className="col-5 col-md-2 my-2 mx-2 mx-md-3 cajitas px-0 py-3 animated bounceInLeft  slow" style={{"background-color": "rgb(60, 228, 116)"}}>
            <div className="row cajita align-items-center">
         <div className="col-12 fixed-top mt-4 ">
    ...
    if(this.state.admin===true||this.state.master===true){
      return <React.Fragment>
        <div className="row justify-content-center  pepito pt-3  fixed-bottom">
               ...
               <div className="col-5 col-md-2 my-2 mx-2 mx-md-3 cajitas px-0 py-3 animated bounceInLeft delay-1" style={{"background-color": "rgb(60, 228, 116)"}}>
               <div className="row cajita align-items-center">
         <div className="col-12 fixed-top mt-4 ">
              ...
              <div className="col-5 col-md-2 my-2 mx-2 mx-md-3 cajitas px-0 py-3 animated bounceInRight delay" style={{"background-color": "rgb(60, 228, 116)"}}>
              <div className="row cajita align-items-center">
         <div className="col-12 fixed-top mt-4 ">
