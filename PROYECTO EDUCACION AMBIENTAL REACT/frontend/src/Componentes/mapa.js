...
import fondito from './Img/fondi4.png'
import fondito2 from './Img/fondi5.png'
    ...
    return(
        <div className="row mx-auto">
            <div className="col-md-6 py-3 py-md-5 ">
                ...
                Educacion Ambiental <h1 className="h1-responsive white-text mt-1 mb-5">Chaco</h1> 
                </h2>
                <div className="animated bounceInDown slower" style={{backgroundImage:`url(${fondito2})`}}>
                <button type="button" onClick={event => guardarCategoria(event="0")} className="btn btn-outline-white btn-rounded waves-effect btn-lg btn-block animated bounceInDown slower "><strong>Recorre la Provincia</strong></button>                   
                </div>
                </div>
           ...
           <div className="col-md-6">
               <br/>
               <div className=" rounded-circle p-4 animated bounceInDown slower" style={{maxWidth:"400px",margin:"auto",backgroundImage:`url(${fondito})`,backgroundSize:"cover",backgroundRepeat:"no-repeat"}}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="pt-4  mb-5 mx-1 text-center animated bounceInDown slower delay-2" width="400px" height='300px' viewBox="0 0 337.792 288.902" style={{marginRight:"100px",marginLeft:"100px",opacity:"0.9",border:"none"}} >
