...
const Interactivo = () =>{
    ...
    return(
        <div className="container">
            <div className="row justify-content-center align-items-center papita">
                <div className="col-12 col-md-4 mr-md-5">
                    <h2 className="px-3 h2-responsive white-text text-center font-roboto my-5 mb-5 ">Educación Ambiental <br/> <strong className="font-lato text-monospace" style={{fontSize:"100px"}}>Chaco</strong>
                    </h2>
                    <ScrollspyNav scrollTargetIds={['section-1']} currentClassName="is-current">
                        <a type="button" href="#section-1" onClick={event => guardarCategoria(event="0")} className="mt-5 botoncito btn btn-outline-white btn-rounded waves-effect btn-lg btn-block animated bounceInDown slower my-3" ><strong>Recorre la Provincia</strong></a>                   
                    </ScrollspyNav>

                
                    
                </div>
                <div className="sinPadin col-12 col-md-4 mb-5 ml-md-5 mb-md-0">
                    <br/>
                    <div className="mapita rounded-circle p-4 animated bounceInDown slower" >
                        <svg xmlns="http://www.w3.org/2000/svg" className=" pt-4  mb-5 text-center  animated bounceInDown slower delay-2" width="400px" height='300px' viewBox="0 0 337.792 288.902" style={{marginRight:"100px",marginLeft:"5px",opacity:"0.9",border:"none"}} >
            ...
            <section className="mb-2" id="section-1">
                 <GetGaleria
            filtro={Categoria}
            />
            </section>
